    ...
    function numberWithCommas(x) {
      ...
      function addFireDispatch(){
        loadingSpinner(true);
          ...
          type:'geojson',
          data:'https:\/\/services3.arcgis.com/T4QMspbfLg3qTGWY/arcgis/rest/services/National_Dispatch_Current/FeatureServer/0/query?where=1%3D1&objectIds=&time=&geometry=&geometryType=esriGeometryEnvelope&inSR=102100&spatialRel=esriSpatialRelIntersects&resultType=tile&&units=esriSRUnit_Meter&returnGeodetic=false&outFields=OBJECTID,GACCName,DispName,DispLocation&returnGeometry=true&returnCentroid=false&featureEncoding=esriDefault&multipatchOption=xyFootprint&maxAllowableOffset=&geometryPrecision=2&outSR=&datumTransformation=&applyVCSProjection=false&returnIdsOnly=false&returnUniqueIdsOnly=false&returnCountOnly=false&returnExtentOnly=false&returnQueryGeometry=false&returnDistinctValues=false&cacheHint=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&having=&resultOffset=&resultRecordCount=&returnZ=false&returnM=false&returnExceededLimitFeatures=true&quantizationParameters=&sqlFormat=none&f=geojson&token='
              // type: 'vector',
            ...
            for(var j = 0; j< hrtimestamps.length;j++){
              map.addLayer({
                ...
                'source': {
                  ...
                  'scheme':'tms',
                  'tiles': [
                  `https:\/\/thredds.ucar.edu/thredds/wms/satellite/goes/18/grb/ABI/FullDisk/Channel02/current/OR_ABI-L1b-RadF-M6C02_G18_${g17f[j]}?LAYERS=Rad&ELEVATION=0&TIME=${g17t[j]}&TRANSPARENT=false&STYLES=default-scalar%2Fseq-GreysRev&COLORSCALERANGE=6,600&NUMCOLORBANDS=250&LOGSCALE=true&ABOVEMAXCOLOR=extend&BELOWMINCOLOR=extend&BGCOLOR=extend&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&FORMAT=image/jpeg&SRS=EPSG:3857&BBOX={bbox-epsg-3857}&WIDTH=512&HEIGHT=512`
                  ],
                  'tileSize': 512,
                  //'maxZoom': 11.99,
                },
